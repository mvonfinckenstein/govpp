...
```sh
# Latest release
go install github.com/mvonfinckenstein/govpp/cmd/binapi-generator@latest

# Specific version
go install github.com/mvonfinckenstein/govpp/cmd/binapi-generator@v0.7.0

# Development branch
go install github.com/mvonfinckenstein/govpp/cmd/binapi-generator@master
```
